      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-24">
          <motion.div
            ...
            viewport={{ once: true }}
            className="p-12 md:p-16 rounded-3xl bg-black/5 border border-black/10 flex flex-col justify-between space-y-12"
          >
            <div className="space-y-6">
              <Watch className="w-10 h-10 text-red mb-6" />
            ...
            <motion.a
              ...
              className="group flex items-center justify-between p-6 bg-red rounded-2xl text-white font-serif font-bold text-xl hover:bg-cyan/90 transition-all duration-300"
            >
        ...
        <div className="mt-32 pt-12 border-t border-black/5 text-center text-gray-500/20 text-xs uppercase tracking-[0.5em] font-sans">
