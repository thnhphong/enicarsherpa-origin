    ...
    >
      <div className="absolute left-[30px] md:left-1/2 top-0 bottom-0 w-[2px] bg-red/10 -translate-x-1/2 z-0">
        <motion.div
          ...
          className="w-full h-full bg-red shadow-[0_0_15px_rgba(255,222,23,0.5)]"
        />
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <header className="mb-32 text-center md:text-left md:pl-[50%]">
          <motion.div
            ...
            className="space-y-4"
          >
            <span className="text-red tracking-[0.4em] uppercase text-sm font-semibold">
              The Journey
            </span>
        ...
        <div className="space-y-64">
          {timelineData.map((item, index) => (
            ...
            >
              <div className="absolute left-[-26px] md:left-1/2 top-0 md:top-1/2 w-20 h-20 bg-white border-2 border-red rounded-full -translate-x-1/2 md:-translate-y-1/2 flex items-center justify-center z-20 shadow-[0_0_20px_rgba(255,222,23,0.2)]">
              ...
              <div className="flex-1 text-center md:text-left w-full md:w-auto">
                <div className="space-y-6">
                  <div className="relative">
                    ...
                    <span className="text-red tracking-[0.3em] font-semibold text-sm uppercase block mb-2">
                      {item.month || "HISTORIC MOMENT"}
                    </span>
                    <h3 className="text-4xl md:text-7xl font-serif font-bold tracking-tight text-black uppercase">
                      {item.title}
                    </h3>
                  </div>
                  <p className="text-lg md:text-xl font-light leading-relaxed text-gray-500 max-w-xl mx-auto md:mx-0">
                    {item.description}
                  </p>
              ...
              <div className="flex-1 w-full grid grid-cols-2 gap-4 aspect-video md:aspect-[4/3]">
                {item.image1 ? (
                  ...
                  <div className="bg-red/5 border border-red/10 rounded-3xl flex items-center justify-center">
                    <span className="text-red/10 font-serif text-6xl italic">
                      {item.year}
                    </span>
                  </div>
                )}
